...
export const HelpBox: React.FC = () => {
  const ownerRoles: string[] = ['Editor'];
  const customerRoles: string[] = [];
  const tenantRoles: string[] = ['Editor', 'Team Member', 'Administrator'];
  const addOns: string[] = ['chat', 'file', 'notifications'];
  const applicationName = `Summary`;
